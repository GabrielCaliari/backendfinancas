...
var UpdateUserController = /** @class */ (function () {
    ...
    UpdateUserController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var id, _a, name, email, password, avatarUrl, updateUserService, user, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        id = request.params.id;
                        _a = request.body, name = _a.name, email = _a.email, password = _a.password, avatarUrl = _a.avatarUrl;
